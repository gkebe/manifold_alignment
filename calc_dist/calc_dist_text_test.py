...
def parse_args():
    ...
    parser.add_argument('--group', help='name of group to evaluate')
...
def evaluate(experiment, test_path, sample_size, gpu_num, embedded_dim, group):
    ...
    vision2language_fout = open(os.path.join(results_dir, f'vision2language_{group}.txt'), 'w')
