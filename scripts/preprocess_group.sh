...
python ./preprocessing/split_data_group.py --data=data/gld_${1}_vision_tensors.pkl --train_limit=6467 --train=data/groups/gld_${1}_accent_vision_train.pkl --test=data/groups/gld_${1}_accent_vision_test.pkl --test_limit=1724 --users "$ACCENT_USER_IDS" >> data/groups/accent.txt
...
python ./preprocessing/split_data_group.py --data=data/gld_${1}_vision_tensors.pkl  --train_limit=6467 --train=data/groups/gld_${1}_nonaccent_vision_train.pkl --test=data/groups/gld_${1}_nonaccent_vision_test.pkl --test_limit=1724 --users "$NONACCENT_USER_IDS" >> data/groups/nonaccent.txt
...
python ./preprocessing/split_data_group.py --data=data/gld_${1}_vision_tensors.pkl --train=data/groups/gld_${1}_men_vision_train.pkl --train_limit 6230 --test_limit 1667 --test=data/groups/gld_${1}_men_vision_test.pkl --users $MEN_USER_IDS >> data/groups/men.txt
...
python ./preprocessing/split_data_group.py --data=data/gld_${1}_vision_tensors.pkl --train=data/groups/gld_${1}_women_vision_train.pkl --train_limit 6230 --test_limit 1667 --test=data/groups/gld_${1}_women_vision_test.pkl --users $WOMEN_USER_IDS >> data/groups/women.txt
...
python ./preprocessing/split_data_group.py --data=data/gld_${1}_vision_tensors.pkl --train=data/groups/gld_${1}_muffled_vision_train.pkl --train_limit=1264 --test_limit=346 --test=data/groups/gld_${1}_muffled_vision_test.pkl --users $MUFFLED_USER_IDS >> data/groups/muffled.txt
...
python ./preprocessing/split_data_group.py --data=data/gld_${1}_vision_tensors.pkl --train=data/groups/gld_${1}_nonmuffled_vision_train.pkl --train_limit=1264 --test_limit=346 --test=data/groups/gld_${1}_nonmuffled_vision_test.pkl --users $NONMUFFLED_USER_IDS >> data/groups/nonmuffled.txt
...
python ./preprocessing/split_data_group.py --data=data/gld_${1}_vision_tensors.pkl --train=data/groups/gld_${1}_background_vision_train.pkl --train_limit=1038 --test_limit=314 --test=data/groups/gld_${1}_background_vision_test.pkl --users $BACKGROUND_USER_IDS >> data/groups/background.txt
...
python ./preprocessing/split_data_group.py --data=data/gld_${1}_vision_tensors.pkl --train=data/groups/gld_${1}_nobackground_vision_train.pkl --train_limit=1038 --test_limit=314 --test=data/groups/gld_${1}_nobackground_vision_test.pkl --users $NOBACKGROUND_USER_IDS >> data/groups/nobackground.txt
...
python ./preprocessing/split_data_group.py --data=data/gld_${1}_vision_tensors.pkl --train=data/groups/gld_${1}_highvolume_vision_train.pkl --train_limit=258 --test_limit=92 --test=data/groups/gld_${1}_highvolume_vision_test.pkl --users $HIGHVOLUME_USER_IDS >> data/groups/highvolume.txt
...
python ./preprocessing/split_data_group.py --data=data/gld_${1}_vision_tensors.pkl --train=data/groups/gld_${1}_mediumvolume_vision_train.pkl --train_limit=258 --test_limit=92 --test=data/groups/gld_${1}_lowvolume_vision_test.pkl --users $LOWVOLUME_USER_IDS >> data/groups/lowvolume.txt
...
python ./preprocessing/split_data_group.py --data=data/gld_${1}_vision_tensors.pkl --train=data/groups/gld_${1}_lowvolume_vision_train.pkl --train_limit=258 --test_limit=92 --test=data/groups/gld_${1}_mediumvolume_vision_test.pkl --users $MEDIUMVOLUME_USER_IDS >> data/groups/mediumvolume.txt
